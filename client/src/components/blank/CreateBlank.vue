    ...
    <v-form ref="form" v-model="valid" lazy-validation>
        ...
        <v-card class="mb-4">
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="12" md="6">
                        <v-text-field type="number" v-model="form.trm" :rules="rules.required"
                            label="Срок обучения (лет)" required></v-text-field>
                    </v-col>
                    <v-col cols="12" md="6">
                        <v-text-field type="number" v-model="form.dateEnd" :rules="[rules.required]"
        ...
        <v-card class="mb-4">
            ...
            <v-card-text>
                <v-row>
                    ...
                    <v-col cols="12" md="6">
                        <v-text-field v-model="form.town" :rules="rules.required" label="Город" required></v-text-field>
                    </v-col>
                </v-row>
            </v-card-text>
        </v-card>
