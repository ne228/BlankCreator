...
<jsp:useBean id="user" scope="request" type="com.smallaxe.blank_creator.entity.User"/>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<div class="container">
    ...
    <%@ page import="com.smallaxe.blank_creator.entity.User" %>
    <%@ page import="com.smallaxe.blank_creator.entity.Role" %>
